import "./PluckedInstruments.scss";
...
function PluckedInstruments(props) {
  return (
    <>
      <Header />
      <Font family="Dosis">
        <div className="plucked__wrap">
          <div className="plucked__contentbox1">
            <h2 className="plucked__title"> "Pipa (琵琶)"</h2>
            <div className="plucked__content">
              <h3 className="plucked__title1">Chinese Orchestra Section:</h3>{" "}
              <p className="plucked__content">Plucked String</p>
            </div>
            <div className="plucked__row">
              <h3 className="plucked__title1">Feature: </h3>
              <p className="plucked__content">
            ...
            <div className="plucked__row">
              <h3 className="plucked__title1">Histroy: </h3>
              <p className="plucked__content">
            ...
            <div className="plucked__row">
              <h3 className="plucked__title1">Content: </h3>
              <p className="plucked__content">
...
<div className="plucked__img" >
          <img className="plucked__pluck" src={Plucked1} alt="plucked1"></img>
          <img className="plucked__pluck" src={Plucked8} alt="plucked8"></img>
</div>
          <div className="plucked__contentbox">
            <h2 className="plucked__title"> "Pipa (琵琶)"</h2>
            <div className="plucked__content">
              <h3 className="plucked__title1">Chinese Orchestra Section:</h3>{" "}
              <p className="plucked__content">Plucked String</p>
        ...
        <div className="plucked__wrap">
          <div className="plucked__contentbox2">
            <h2 className="plucked__title"> Guzheng (古箏)</h2>
            <div className="plucked__content">
              <h3 className="plucked__title1">Chinese Orchestra Section:</h3>{" "}
              <p className="plucked__content">Plucked String</p>
            </div>
          ...
          <div className="plucked__img" >
          <img className="plucked__pluck" src={Plucked3} alt="plucked4"></img>

          <img className="plucked__pluck" src={Plucked4} alt="plucked3"></img>
        </div>
</div>
        <div className="plucked__wrap">
          <div className="plucked__contentbox1">
            <h2 className="plucked__title"> Ruan (阮)</h2>
            <div className="plucked__content">
              <h3 className="plucked__title1">Chinese Orchestra Section:</h3>{" "}
              <p className="plucked__content">Plucked String</p>
            </div>
          ...
          <div className="plucked__img" >
          <img className="plucked__pluck" src={Plucked5} alt="plucked7"></img>
          <img className="plucked__pluck" src={Plucked6} alt="plucked2"></img>
</div>
          <div className="plucked__contentbox">
            <h2 className="plucked__title"> Ruan (阮)</h2>
            <div className="plucked__content">
        ...
        <div className="plucked__wrap">
          <div className="plucked__contentbox2">
            <h2 className="plucked__title"> Liuqin (柳琴)</h2>
            <div className="plucked__content">
              <h3 className="plucked__title1">Chinese Orchestra Section:</h3>{" "}
              <p className="plucked__content">Plucked String</p>
            </div>
          ...
          <div className="plucked__img" >
          <img className="plucked__pluck" src={Plucked2} alt="plucked5"></img>
          <img className="plucked__pluck" src={Plucked7} alt="plucked6"></img>
        </div>
        </div>
      </Font>
